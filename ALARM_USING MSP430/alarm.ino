...
const int button1   = 38;                   // button1 pin number
const int button2   = 39;                   // button1 pin number
const int button3   = 40;                   // button1 pin number
...
void setup() {
  ...
  attachInterrupt(digitalPinToInterrupt(37), Alarm, FALLING);
}
